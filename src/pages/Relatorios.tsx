    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card><CardContent className="pt-6">
          ...
          <p className="text-2xl font-bold text-green-600">R$ {faturamento.pago.toFixed(2)}</p>
        </CardContent></Card>
        <Card><CardContent className="pt-6">
          <p className="text-sm text-muted-foreground">Total em aberto</p>
          <p className="text-2xl font-bold text-amber-600">R$ {faturamento.pendente.toFixed(2)}</p>
        </CardContent></Card>
      </div>
